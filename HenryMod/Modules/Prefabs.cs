...
namespace PlayableTemplar.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = PlayableTemplarPlugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = PlayableTemplarPlugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = PlayableTemplarPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = PlayableTemplarPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            PlayableTemplarPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            PlayableTemplarPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            PlayableTemplarPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
